        ...
        return (
            <ScrollView style={ApplicationStyles.container}>
                <Card>
                    ...
                    <Text style={[ApplicationStyles.h3]}> 1. INFORMAÇÕES GERAIS/DEFINIÇÕES </Text>
                    <Text>
                    ...
                    <Text style={[ApplicationStyles.h3]}>2a - ALTERAÇÃO DAS CIRCUNSTÂNCIAS:</Text>
                    <Text>
                    ...
                    <Text style={[ApplicationStyles.h3]}>3a - SOBRE OS DADOS PESSOAIS:</Text>
                    <Text>
