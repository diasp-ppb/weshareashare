    ...
    return (
      <ScrollView style={ApplicationStyles.container}>
        <Card>
          ...
          <BulletText bulletColor={Colors.stoikOrange} text={'O nosso objetivo é continuar a providenciar os retornos sólidos da família de estratégias Stoik, proporcionando ao mesmo tempo, uma oportunidade para que possa apoiar uma determinada causa em que acredita.'}/>
